...
class Config:
    ...
    def __init__(self):
        ...
        self.database_url = os.getenv("DATABASE_PUBLIC_URL") or os.getenv(
            "DATABASE_URL", "postgresql://localhost/tg_analytics"
        )
        ...
        self.admin_users = [
            int(x.strip()) for x in admin_users_str.split(",") if x.strip().isdigit()
        ]
