...
def show_configuration():
    ...
    config_vars = [
        ...
        ('DATABASE_URL', 'установлен' if os.getenv('DATABASE_URL') else 'не установлен'),
...
def show_next_steps():
    ...
    print("3. Добавьте группы для мониторинга: python scripts/manage_groups.py add @username")
